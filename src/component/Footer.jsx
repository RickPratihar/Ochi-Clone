...
const Footer = () => {
  return (
    <div data-scroll data-scroll-speed="0.1" className="flex flex-col md:flex-row gap-5 w-full h-screen bg-[#F1F1F1] p-20 font-['Founders_Grotesk-X-condensed']">
      <div className="w-1/2 h-full flex flex-col justify-between ">
        <div className="heading">
          <h1 className="text-[6vw] font-bold uppercase leading-none -mb-4 tracking-tighter">
            Eye-
          </h1>
          <h1 className="text-[6vw] font-bold uppercase leading-none -mb-4 tracking-tighter">
            Opening
      ...
      <div className="w-1/2">
        ...
        <div className="details font-['Neue_Montreal '] mt-20">
          <a className="block text-2xl underline font-light" href="">Instagram</a>
          <a className="block text-2xl underline font-light" href="">Behance</a>
          <a className="block text-2xl underline font-light" href="">Facebook</a>
          <a className="block text-2xl underline font-light" href="">Linkedin</a>
        </div>
      </div>
    </div>
  );
