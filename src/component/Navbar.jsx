...
const Navbar = () => {
  ...
  return (
    <nav>
    <div className=" fixed z-[999] w-full p-3 md:px-20 py-6 font-['Neue Montreal'] flex justify-between items-center">
      <div className="logo">
        <svg
          width="72"
          height="30"
      ...
      <div className="links gap-10 hidden md:flex ">
        {navLinks.map((item, index) => (
          <a
            key={index}
            className={`text-xl capitalize font-semibold cursor-pointer ${
              index === 4 && "ml-60"
            }`}
          >
            {item}
      ...
      {nav && (
        <div className="flex flex-col md:hidden absolute mt-52 px-2 cursor-pointer">
        {navLinks.map((item, index) => (
          <a
            key={index}
            className="text-xl capitaliz "
          >
            {item}
          </a>
        ))}
